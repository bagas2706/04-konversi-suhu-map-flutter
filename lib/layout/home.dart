...
import 'package:widget_map/widget/dropdown.dart';
import 'package:widget_map/widget/result.dart';
import 'package:widget_map/widget/conversion.dart';
import 'package:widget_map/widget/user.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Text('Bagas Prambudi',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const Text('2031710108',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(
            height: 10,
          ),
